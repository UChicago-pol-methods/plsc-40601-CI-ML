...
\[
Y_i = \mathbbm{1}\{W_i = 1 \}Y_i(1) +  \mathbbm{1}\{W_i = 0 \} Y_i(0) 
\]\pause
...
\item $0< \Pr[W_i = 1] <1$ (positivity)\pause
\end{itemize}
...
\begin{figure}
\centering
\includegraphics[width = 0.6\textwidth]{arthur-samuel-according-to-bing.png}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width = 0.6\textwidth]{arthur-samuel-according-to-chatgpt.png}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width = 0.8\textwidth]{samuel-refute-stackexchange.png}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{breiman_2001AM-culture.png}
\end{figure}
