...
Variable splits: 
(1) split_variable: X.1  split_value: 0.0766393 
  (2) split_variable: X.1  split_value: -0.132755 
    (4) split_variable: X.3  split_value: 0.144256 
      (8) split_variable: X.8  split_value: -0.417199 
        (14) * num_samples: 7  avg_Y: -0.88 avg_W: 0.29 
        (15) * num_samples: 25  avg_Y: -1.14 avg_W: 0.44 
      (9) * num_samples: 23  avg_Y: -0.21 avg_W: 0.39 
    (5) * num_samples: 16  avg_Y: -0.81 avg_W: 0.44 
  (3) split_variable: X.4  split_value: -0.3755 
    (6) split_variable: X.7  split_value: 0.0975646 
      (10) * num_samples: 10  avg_Y: -0.15 avg_W: 0.6 
      (11) * num_samples: 6  avg_Y: 0.12 avg_W: 0.5 
    (7) split_variable: X.1  split_value: 1.16291 
      (12) split_variable: X.5  split_value: -0.0522993 
        (16) * num_samples: 12  avg_Y: -0.62 avg_W: 0.33 
        (17) * num_samples: 20  avg_Y: -0.17 avg_W: 0.45 
      (13) * num_samples: 6  avg_Y: 0.49 avg_W: 0.5 
\end{Soutput}
\end{Schunk}
...
\begin{figure}
\centering
\includegraphics[width = 0.8\textwidth]{tree-plot.png}
\end{figure}
\hfill
\end{frame}
