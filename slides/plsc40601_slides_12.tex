...
\item \url{https://economics.uchicago.edu/events/workshops/econometrics-workshop} 
\item \url{https://voices.uchicago.edu/psquant/}
\item \url{https://www.chicagobooth.edu/faculty/research-workshops/econometrics-and-statistics}\pause
\item \url{https://bookdown.org/halflearned/ml-ci-tutorial/}
\item \url{https://www.gsb.stanford.edu/faculty-research/labs-initiatives/sil/research/methods/ai-machine-learning/short-course}
\end{wideitemize}
...
\begin{figure}
\centering
\includegraphics[width = 0.4\textwidth]{../assets/arthur-samuel-according-to-chatgpt.png}
\end{figure}
