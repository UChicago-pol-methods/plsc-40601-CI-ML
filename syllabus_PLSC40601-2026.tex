...
\begin{itemize}
\item \bibentry{athey2018approximate}
\end{itemize}
...
\item \textit{Optional/reference:} \bibentry{nie2021quasioracle}
\end{itemize}
...
\item \textit{Optional/reference:} \bibentry{miao2018identifying}
\end{itemize}
...
\subsubsection*{Wednesday.}
\begin{itemize}
\item \bibentry{pmlr-v70-hartford17a}
\end{itemize}
...
\subsubsection*{Wednesday.}
\begin{itemize}
\item \bibentry{dahabreh2019generalizing}
\item \textit{Optional/reference:} \bibentry{pearl2014external}
\end{itemize}
